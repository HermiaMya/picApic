...
.upp .avatar-uploader .upp .el-upload {
...
.upp .avatar-uploader .upp .el-upload:hover {
  border-color: #409eff;
}
.upp .el-upload--picture-card {
  width: 320px;
  height: 320px;
  line-height: 300px;
  background: none;
...
.upp .el-upload-list--picture-card .el-upload-list__item-actions {
    position: absolute;
    width: 320px;
    height: auto;
    left: 0;
...
.upp.el-upload-list--picture-card .el-upload-list__item-thumbnail {
    width: 320px;
    height: auto;
}
.upp .avatar-uploader-icon {
  font-size: 28px;
  color: #8c939d;
  width: 500px;
  height: 500px;
